    ...
    >
      <div className="flex justify-between items-center mb-2">
        <div className="flex items-center gap-2">
          ...
          <span className={`text-xs px-2 py-0.5 rounded-full bg-gradient-to-r ${getSkillColor(skill.level)} text-white font-medium`}>
...
const CategoryCard = ({ category, index }) => {
  ...
  return (
    ...
    >
      ...
      <div className={`absolute -inset-0.5 bg-gradient-to-r ${category.color} rounded-xl blur opacity-0 group-hover:opacity-20 transition-opacity duration-300`} />
      
      {/* Main Card */}
      <div className="relative p-6 rounded-xl bg-[var(--background)]/90 backdrop-blur-sm border border-[var(--border)]/30 hover:border-[var(--primary)]/50 transition-all duration-300">
        {/* Header */}
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center gap-3">
            <div className={`w-10 h-10 rounded-full bg-gradient-to-r ${category.color} flex items-center justify-center text-white text-lg`}>
              {category.icon}
            </div>
            <div>
          ...
          <button
            ...
            className="p-2 rounded-lg hover:bg-[var(--muted)]/50 transition-colors flex items-center justify-center"
          >
            {isExpanded ? (
...
const SectionHeader = () => {
  ...
  return (
    ...
    >
      ...
      {/* Skill Summary - Simplified */}
      <div className="flex justify-center gap-6 mt-6">
        <div className="text-center">
          <div className="text-2xl font-bold text-[var(--primary)]">25+</div>
        ...
        <div className="text-center">
          <div className="text-2xl font-bold text-[var(--primary)]">60%</div>
...
const SkillsSection = () => {
  ...
  return (
    <section className="py-12 px-0"> {/* px-0 əlavə edildi */}
      <SectionHeader />
      ...
      <motion.div
        ...
        initial="hidden"
        animate={isInView ? "visible" : "hidden"}
        className="grid grid-cols-1 md:grid-cols-2 gap-4 px-0 mx-auto w-full"
      >
