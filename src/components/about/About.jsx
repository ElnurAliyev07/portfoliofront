...
const EXPERIENCES = [
  {
    ...
    isCurrent: false,
    description:
      "Completed a degree in Information Security. Gained a solid understanding of cybersecurity concepts such as network protection, cryptography, and system security. Also explored how AI and machine learning can be used in security-related tasks like threat detection and biometric verification.",
    achievements: [
    ...
    technologies: [
      ...
      "Vulnerability Testing & Simple Penetration Testing",
      "Cryptography Fundamentals",
      "Linux and Windows System Security",
      "Secure Web Practices (OWASP Top 10 awareness)",
    ],
    category: "Education",
  },
  {
    ...
    description:
      "Gained hands-on experience in machine learning workflows including data preprocessing, model development using scikit-learn, and data analysis. Worked on real-world ML projects and contributed to data-driven solutions.",
    achievements: [
...
const SectionHeader = ({ title, subtitle, className = "" }) => (
  <motion.div {...fadeInUp} viewport={{ once: true }} className={`text-center mb-12 ${className}`}>
...
const ExperienceCard = ({ experience, index }) => {
  ...
  return (
    <motion.div
      ...
      viewport={{ once: true }}
      className={`relative flex items-center ${isEven ? "md:flex-row" : "md:flex-row-reverse"} z-0`}
    >
      {/* Timeline dot */}
      ...
      {/* Content */}
      <div className={`ml-12 sm:ml-16 md:ml-0 md:w-1/2 ${isEven ? "md:pr-8" : "md:pl-8"}`}>
        <div className="p-6 rounded-xl bg-[var(--background)]/80 backdrop-blur-sm border border-[var(--border)]/50 hover:border-purple-500/30 transition-all duration-300">
          <div className="flex items-start justify-between mb-4">
            ...
            <span className={`px-3 py-1 rounded-full text-xs font-medium ${getExperienceStyles(experience.type)}`}>
              {experience.category}
            </span>
          </div>
...
const ExperienceTimeline = () => (
  <section id="experience" className="py-16 px-4">
    <div className="max-w-4xl mx-auto">
      ...
      <div className="relative pt-12 md:pt-24 z-0">
        {/* Timeline line */}
  ...
  <div className="mb-16 px-4 sm:px-6 lg:px-8">
    ...
    >
      <p className="text-base text-muted-foreground leading-relaxed">
        I'm a graduate in Information Security from the Academy of the State Customs Committee. I have a solid
        background in Python and specialize in building practical AI/ML solutions and full-stack applications.
      </p>
      <p className="text-base text-muted-foreground leading-relaxed">
        Over time, I've focused on developing intelligent systems using tools like Django, React, and machine learning
        frameworks. My key areas of interest include computer vision, facial recognition, and creating useful,
        real-world applications that combine backend logic with smart AI features.
      </p>
      <p className="text-base text-muted-foreground leading-relaxed">
        I'm currently seeking opportunities where I can apply my skills in AI/ML and backend development, collaborate
        with others on meaningful projects, and continue learning and growing as a developer.
      </p>
    </motion.div>
  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto">
        <SectionHeader title="About Me" className="text-gray-200 mb-12" />
